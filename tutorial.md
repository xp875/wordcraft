...
## Tutorial from old version (Minecraft Text Game)
...
`hearts`
Toggles whether to show the player's health using hearts every move. This is off by default. 
...
```
4 stone + 2 iron + diamond => portal_fram
3 eye_of_ender + 3 portal_frame => end_portal
