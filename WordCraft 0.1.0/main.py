...
def intro():
	print("""
Welcome to WordCraft, a text-based game basedd on Minecraft.
...
def move_zombie(m):
	...
	if armour_protection > 0 and	rng.rand_int(1, 100) <= 22:
...
def mine(m):
	...
	s = m[0].upper() + m[1:]
	return player.mine_structure(s)
